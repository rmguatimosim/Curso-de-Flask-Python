...
def  getProducts():
    ...
    for product in products:
        ...
        product_list.append(productData)
...
def addToCart(product_id):
    ...
    if user and product:
        cartItem = CartItem(userID = user.id, product_id = product.id)
...
def removeFromCart(product_id):
    cartItem = CartItem.query.filter_by(userID=current_user.id,product_id=product_id).first()
    if cartItem:
